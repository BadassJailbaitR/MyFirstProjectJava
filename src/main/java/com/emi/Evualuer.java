...
public class Evualuer extends javax.swing.JFrame {
	/**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Les Terrains Disponibles");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Evualuer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
